...
const SwapTokenConfirm: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-3xl text-gray-1400 font-dm-sans">
      <div className="absolute top-[125px] left-[449px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[614px] h-[567px] overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-start gap-[28px]">
            <div className="flex flex-col items-center justify-start gap-[28px]">
              <div className="flex flex-col items-center justify-start gap-[12px]">
                ...
                <div className="relative text-7xl text-left inline-block text-gray-700">
                  <span className="font-medium">{`You sell: `}</span>
                  <b className="text-gray-1600">BTC 0.004</b>
                </div>
              </div>
                ...
                <div className="flex flex-col items-center justify-start gap-[28px]">
                  <div className="flex flex-row items-center justify-center gap-[10px]">
                    <img
                      ...
                      alt=""
                      src="../assets/vuesaxlinearframe.svg"
                    />
                    <div className="relative font-medium inline-block">
                      Details
                    </div>
                  </div>
                  <div className="flex flex-col items-start justify-start gap-[18px] text-3xl text-gray-1400">
                    <div className="relative w-[332px] h-[24px] shrink-0">
                      ...
                      <FormControl
                        className="absolute top-[0px] left-[214px]"
                        sx={{ width: 118 }}
                        variant="outlined"
                        required
                      >
                        <InputLabel color="primary">Funding wallet</InputLabel>
                        <Select
                          color="primary"
                          size="medium"
                    ...
                    <div className="relative w-[332px] h-[24px] shrink-0">
                      ...
                      <FormControl
                        className="absolute top-[0px] left-[212px]"
                        sx={{ width: 120 }}
                        variant="outlined"
                        required
                      >
                        <InputLabel color="primary">Wallet balance</InputLabel>
                        <Select
                          color="primary"
                          size="medium"
                    ...
                    <div className="relative w-[332px] h-[24px] shrink-0 hidden">
                      <div className="absolute top-[0px] left-[calc(50%_-_166px)] leading-[170%] inline-block mix-blend-normal">
                        Account Number
                      </div>
                      <div className="absolute top-[0px] left-[210px] flex flex-row items-center justify-start gap-[9px] text-gray-1600">
                        ...
                        <img
                          ...
                          alt=""
                          src="../assets/vuesaxlineardocumentcopy.svg"
                        />
                      </div>
                    </div>
                  </div>
            ...
            <div className="w-[336px] hidden flex-row items-start justify-start gap-[8px] text-left text-base text-gray-1300">
              <img
                className="relative w-[16px] h-[16px] shrink-0"
                alt=""
                src="../assets/status9.svg"
              />
        ...
        <div className="absolute top-[40px] left-[40px] w-[380px] h-[24px] text-left text-7xl text-gray-1600">
          <div className="absolute h-full w-[46.05%] top-[0%] right-[53.95%] bottom-[0%] left-[0%] flex flex-row items-center justify-start gap-[14px]">
            ...
            />
            <b className="relative inline-block">Summary</b>
          </div>
        </div>
      </div>
...
export default SwapTokenConfirm;
