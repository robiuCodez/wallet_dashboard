...
const BankDetails: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[0px] left-[-6px] w-[1512px] h-[982px]">
        <div className="absolute top-[0px] left-[0px] bg-white w-[1512px] h-[982px] overflow-hidden">
          <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[390px]">
            <div className="absolute top-[70px] left-[77px] flex flex-col items-center justify-start gap-[40px]">
              <div className="flex flex-col items-center justify-start">
                <div className="flex flex-col items-center justify-start gap-[24px]">
                  <img
                    className="relative w-[80px] h-[80px] shrink-0"
                    alt=""
                    src="../assets/group-44750.svg"
                  />
                  <div className="flex flex-col items-center justify-start gap-[8px]">
                    <b className="relative inline-block w-[399px]">
                      ...
                      <p className="m-[0]">any bank detail</p>
                    </b>
                    <div className="relative text-3xl leading-[24px] text-gray-700 hidden w-[309px]">
