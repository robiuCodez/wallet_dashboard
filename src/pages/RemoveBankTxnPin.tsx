...
const RemoveBankTxnPin: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[511px]">
        <div className="absolute top-[88px] left-[86px] flex flex-col items-center justify-start gap-[60px]">
          <div className="flex flex-col items-center justify-start gap-[50px]">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              <img
                ...
                alt=""
                src="../assets/group-44621.svg"
              />
              <div className="flex flex-col items-center justify-start gap-[8px]">
                <b className="relative inline-block">Enter transaction pin</b>
            ...
            <div className="flex flex-row items-start justify-start gap-[24px]">
              <input
                className="[border:none] bg-[transparent] relative w-[18px] h-[18px] shrink-0"
                type="text"
                maxLength={1}
                minLength={1}
                required
...
export default RemoveBankTxnPin;
