...
const FAHome: FunctionComponent = () => {
  return (
        ...
        <div className="absolute top-[88px] left-[58px] flex flex-col items-center justify-start gap-[40px]">
          <div className="flex flex-col items-center justify-start gap-[40px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[20px] text-left text-5xl">
              <Link
                className="cursor-pointer [text-decoration:none] relative w-[395.5px] h-[113px] shrink-0 text-[inherit]"
                to="/2fa-otp"
              >
                <div className="absolute top-[0px] left-[0px] rounded-[16px] bg-gray-400 flex flex-col p-[18px] box-border items-start justify-start">
                  <div className="relative w-[359.5px] h-[77px] shrink-0">
                    <FormControlLabel
                      className="absolute top-[0px] left-[323.5px]"
                      label=""
                    ...
                    <div className="absolute top-[0px] left-[0px] w-[315px] h-[77px]">
                      ...
                      <img
                        ...
                        alt=""
                        src="../assets/group-44232.svg"
                      />
                    </div>
                  </div>
                </div>
              </Link>
              <div className="relative w-[396.25px] h-[114px] shrink-0">
                <Link
                  className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[0px] w-[396.25px] h-[114px] text-[inherit]"
                  to="/2fa-otp"
                >
                  <div className="absolute top-[0px] left-[0px] rounded-[16px] bg-gray-400 flex flex-col p-[18px] box-border items-start justify-start">
                    <div className="relative w-[360.25px] h-[78px] shrink-0">
                      <FormControlLabel
                        className="absolute top-[0px] left-[324.25px]"
                        label=""
                        control={<Switch color="primary" size="medium" />}
                      />
                      <div className="absolute top-[1px] left-[0px] w-[315px] h-[77px]">
                        <div className="absolute top-[2px] left-[64px] flex flex-col items-start justify-start gap-[6px]">
                          <div className="relative font-medium inline-block">
                            Email authentication
                          </div>
                          <div className="relative text-xl leading-[24px] text-gray-700 inline-block w-[251px]">
                            Email authentication adds an extra layer of
                            protection to your transactions.
                          </div>
                        </div>
                        <img
                          className="absolute top-[0px] left-[0px] w-[48px] h-[48px]"
                          alt=""
                          src="../assets/group-44233.svg"
                        />
                      </div>
                    </div>
                  </div>
