...
const ReceiveAddrCopied: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1400 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[595px]">
        <div className="absolute top-[40px] left-[86px] flex flex-col items-center justify-start gap-[24px]">
          <div className="flex flex-col items-center justify-start gap-[20px]">
            <div className="flex flex-col items-center justify-start text-gray-1600">
            ...
            <div className="rounded-[20px] bg-white flex flex-row p-[20px] box-border items-start justify-start relative gap-[10px] text-[11.5px]">
              <img
                className="relative w-[226px] h-[226px] shrink-0 z-[0]"
                alt=""
                src="../assets/qr-code.svg"
              />
              <div className="absolute m-[0_!important] top-[54px] left-[54px] w-[158px] h-[158px] shrink-0 z-[1]">
                <div className="absolute top-[0px] left-[0px] rounded-[18px] bg-white w-[158px] h-[158px]" />
                <div className="absolute top-[37px] left-[33px] flex flex-col items-center justify-start gap-[10px]">
                  <img
                    className="relative w-[60px] h-[60px] shrink-0"
                    alt=""
                    src="../assets/vuesaxboldtickcircle5.svg"
                  />
                  <div className="relative tracking-[-0.01em] font-medium flex items-center justify-center w-[92.75px]">
                    Address copied
                  </div>
                </div>
              </div>
            </div>
            <div className="relative text-3xl text-left inline-block">
        ...
        <div className="absolute top-[44px] left-[40px] w-[380px] h-[24px] text-left text-7xl text-gray-1600">
...
export default ReceiveAddrCopied;
