...
const UpgradeLevel21: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[623px]">
        <div className="absolute top-[88px] left-[86px] flex flex-col items-center justify-start gap-[40px]">
          <div className="flex flex-col items-center justify-start gap-[40px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[20px] text-left text-5xl">
              ...
              <Link
                className="cursor-pointer [text-decoration:none] relative w-[380px] h-[105px] shrink-0 text-7xl text-[inherit]"
                to="/upgrade-level2-verified"
              >
                <div className="absolute top-[0px] left-[0px] rounded-[16px] bg-gray-400 w-[380px] flex flex-col p-[18px] box-border items-start justify-start gap-[10px]">
                  ...
                  <img
                    className="absolute m-[0_!important] top-[18px] left-[326px] w-[34px] h-[34px] shrink-0 z-[1]"
                    alt=""
                    src="../assets/group-448.svg"
                  />
                </div>
              </Link>
            </div>
