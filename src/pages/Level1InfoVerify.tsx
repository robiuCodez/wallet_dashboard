...
const Level1InfoVerify: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-gray-1600 font-dm-sans">
      ...
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[807px] text-11xl">
        <div className="absolute top-[88px] left-[102px] flex flex-col items-center justify-start gap-[40px]">
          <div className="flex flex-col items-center justify-start gap-[40px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[40px] text-left text-base text-gray-1400">
              <div className="flex flex-col items-center justify-start gap-[20px]">
                <div className="relative w-[348px] h-[65px] shrink-0">
                  <div className="absolute h-[89.23%] w-full top-[10.77%] right-[0%] bottom-[0%] left-[0%] rounded-[12px] [border:1px_solid_#cacccf] box-border" />
                  <div className="absolute top-[calc(50%_-_33.5px)] left-[13px] bg-white flex flex-row p-[0px_8px_0px_6px] box-border items-center justify-start">
                    <div className="relative font-medium inline-block">
                      First Name
                    </div>
                  </div>
                  <div className="absolute h-[27.69%] w-[18.68%] top-[41.54%] right-[75.57%] bottom-[30.77%] left-[5.75%] text-3xl inline-block">
                    Investor
                  </div>
                </div>
                <div className="relative w-[348px] h-[65px] shrink-0">
                ...
                <div className="relative w-[348px] h-[65px] shrink-0">
                  ...
                  <div className="absolute h-[27.69%] w-[22.13%] top-[41.54%] right-[72.13%] bottom-[30.77%] left-[5.75%] text-3xl inline-block">
                    30/04/1999
                  </div>
                  <img
                    className="absolute h-[30.77%] w-[5.75%] top-[40%] right-[4.02%] bottom-[29.23%] left-[90.23%] max-w-full overflow-hidden max-h-full"
                    alt=""
                    src="../assets/vuesaxlinearcalendar.svg"
                  />
                </div>
              </div>
              <div className="relative w-[348px] h-[54px] shrink-0 text-center text-5xl text-white">
                ...
                <div className="absolute top-[17px] left-[152px] w-[76px] flex flex-row items-center justify-center gap-[8px]">
                  <img
...
export default Level1InfoVerify;
