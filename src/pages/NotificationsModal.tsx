...
const NotificationsModal: FunctionComponent = () => {
  ...
  const onNotificationsModalContainerClick = useCallback(() => {
    navigate("/wallet-home");
  }, [navigate]);

  return (
    <div
      className="relative bg-white w-full h-[982px] overflow-hidden cursor-pointer text-left text-5xl text-white font-dm-sans"
      onClick={onNotificationsModalContainerClick}
    >
      <div className="absolute top-[0px] left-[0px] w-[1512px] h-[65px]">
        ...
        >
          <img
            ...
            alt=""
            src="../assets/vuesaxboldnotification28.svg"
          />
      ...
      <div className="absolute top-[125px] left-[150px] flex flex-row items-start justify-start gap-[32px] text-3xl text-gray-700">
                ...
                <div className="absolute top-[0px] left-[0px] w-[124px] h-[48px]">
                  ...
                  <div className="absolute top-[calc(50%_-_11px)] left-[calc(50%_-_42px)] w-[84px] flex flex-row items-center justify-center gap-[10px]">
                    <img
                      className="relative w-[20px] h-[20px] shrink-0"
                      alt=""
                      src="../assets/vuesaxlinearcard12.svg"
                    />
                ...
                >
                  ...
                  <div className="absolute top-[calc(50%_-_11px)] left-[calc(50%_-_42px)] w-[84px] flex flex-row items-center justify-center gap-[10px]">
                    <img
                      className="relative w-[20px] h-[20px] shrink-0"
                      alt=""
                      src="../assets/vuesaxlinearmoneys6.svg"
                    />
                    <div className="relative font-medium inline-block">
                      Withdraw
                    </div>
      ...
      <div className="absolute top-[75px] left-[772px] w-[590px] h-[524px] text-7xl text-gray-1400">
        <div className="absolute top-[0px] left-[0px] w-[590px] h-[524px]">
          <div className="absolute top-[0px] left-[0px] rounded-[15px] bg-white w-[590px] h-[524px]" />
          <b className="absolute top-[28px] left-[28px] inline-block">
            Notifications
          </b>
          <img
            className="absolute top-[103px] left-[1310px] w-[24px] h-[24px] opacity-[0]"
            alt=""
          />
          <div className="absolute top-[71px] left-[28px] h-[453px] overflow-y-auto flex flex-col items-start justify-start gap-[20px] text-gray-1600">
            <div className="flex flex-col items-start justify-start gap-[12px]">
              <div className="relative font-medium inline-block">New</div>
              <div className="flex flex-col items-start justify-start gap-[18px] text-3xl">
                <div className="relative w-[534px] h-[72px] shrink-0">
                  <div className="absolute top-[0px] left-[0px] rounded-[12px] bg-gray-400 w-[534px] h-[72px]" />
                  <div className="absolute top-[16px] left-[17px] w-[255px] h-[40px]">
                    <div className="absolute top-[1px] left-[54px] flex flex-col items-start justify-start gap-[4px]">
                      <div className="relative inline-block">
                  ...
                  <div className="absolute top-[20px] left-[449px] rounded-[6px] bg-white flex flex-row p-[8px_10px] box-border items-center justify-center opacity-[0] text-base text-orange">
                    <div className="relative inline-block">Pending</div>
                  </div>
                </div>
                <div className="relative w-[534px] h-[72px] shrink-0">
                  ...
                  <div className="absolute top-[20px] left-[434px] rounded-[6px] bg-white flex flex-row p-[8px_10px] box-border items-center justify-center opacity-[0] text-base text-green-100">
                    <div className="relative inline-block">Successful</div>
                  </div>
                </div>
                <div className="relative w-[534px] h-[72px] shrink-0">
                  <div className="absolute top-[0px] left-[0px] rounded-[12px] bg-gray-400 w-[534px] h-[72px]" />
                  <div className="absolute top-[16px] left-[17px] w-[256px] h-[40px]">
                    <div className="absolute top-[1px] left-[54px] flex flex-col items-start justify-start gap-[4px]">
                      <div className="relative font-medium inline-block">
            ...
            <div className="flex flex-col items-start justify-start gap-[12px]">
              <div className="relative font-medium inline-block">Yesterday</div>
              <div className="flex flex-col items-start justify-start gap-[18px] text-3xl">
                <div className="relative w-[534px] h-[72px] shrink-0">
                  <div className="absolute top-[0px] left-[0px] rounded-[12px] bg-gray-400 w-[534px] h-[72px]" />
                  <div className="absolute top-[16px] left-[17px] w-[255px] h-[40px]">
