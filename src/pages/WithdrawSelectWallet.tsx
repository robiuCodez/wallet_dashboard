...
const WithdrawSelectWallet: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-left text-5xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[449px] rounded-[20px] [border:1px_solid_#e8e8e8] box-border w-[614px] h-[809px] overflow-hidden">
        <div className="absolute top-[40px] left-[40px] flex flex-col items-start justify-start gap-[27px]">
          ...
          <div className="h-[909px] shrink-0 overflow-y-auto flex flex-col items-start justify-start gap-[20px] text-right">
            <Link
              className="cursor-pointer [text-decoration:none] relative w-[534px] h-[83px] shrink-0 text-[inherit]"
              to="/withdraw-amt-finish"
            >
              <Link
                className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[0px] w-[534px] h-[83px] text-[inherit]"
                to="/withdraw-amount2"
              >
                <div className="absolute top-[0px] left-[0px] w-[534px] h-[83px]">
        ...
        <div className="absolute top-[136px] left-[604px] border-r-[6px_solid_#cacccf] box-border w-[6px] h-[53px]" />
      </div>
