...
const FASucces: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-gray-1600 font-dm-sans">
      ...
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[593px] text-11xl">
          ...
          <div className="flex flex-col items-center justify-start gap-[30px]">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              <img
                ...
                alt=""
                src="../assets/group-44722.svg"
              />
              <div className="flex flex-col items-center justify-start gap-[8px]">
                <b className="relative inline-block">Enter the 2FA code</b>
                <div className="relative text-3xl leading-[24px] text-gray-700 inline-block w-[362px]">
                  Type in the 6-digit code received on your phone number to
                  enable 2FA
                </div>
              </div>
            </div>
