...
const ConfirmBankDetails: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[737px]">
        <div className="absolute top-[88px] left-[86px] flex flex-col items-center justify-start gap-[20px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[18px] text-5xl">
            <Button
              className="relative"
              sx={{ width: 380 }}
              variant="contained"
              color="primary"
              href="/bankdetailssuccess"
            >
              Yes, It matches
            </Button>
        ...
        <div className="absolute top-[585px] left-[114.5px] hidden text-5xl text-white">
