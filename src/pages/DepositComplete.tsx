...
const DepositComplete: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-gray-1600 font-dm-sans">
      ...
      <div className="absolute top-[125px] left-[533px] rounded-[20px] bg-white w-[446px] h-[388px] flex flex-col items-center justify-center gap-[40px] text-9xl">
        <div className="flex flex-col items-center justify-start gap-[30px] z-[0]">
          <img
            className="relative w-[90px] h-[90px] shrink-0"
            alt=""
            src="../assets/group-44713.svg"
          />
          <div className="flex flex-col items-center justify-start gap-[8px]">
            <b className="relative inline-block">
              <p className="[margin-block-start:0] [margin-block-end:0px]">{`Your deposited funds are `}</p>
              <p className="m-[0]">on the way</p>
            </b>
            <div className="relative text-3xl leading-[24px] text-gray-700 inline-block w-[309px]">
              Check your email for the transaction details
            </div>
          </div>
        </div>
        <img
          className="absolute m-[0_!important] top-[28px] right-[28px] w-[24px] h-[24px] shrink-0 z-[1]"
          alt=""
