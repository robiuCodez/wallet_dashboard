...
const TxnHistoryModal: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-left text-5xl text-white font-dm-sans">
      <div className="absolute top-[0px] left-[0px] w-[1512px] h-[65px]">
        ...
        >
          <img
            ...
            alt=""
            src="../assets/vuesaxboldnotification29.svg"
          />
            ...
            <div className="absolute h-[15.81%] w-[90.51%] top-[11.07%] right-[4.75%] bottom-[73.12%] left-[4.75%]">
              <div className="absolute h-[90%] w-[6.74%] top-[5%] right-[0%] bottom-[5%] left-[93.26%] rounded-[8px] bg-gray-400 flex flex-row p-[8px] box-border items-start justify-start">
                <img
                  ...
                  alt=""
                  src="../assets/vuesaxlineareyeslash9.svg"
                />
              </div>
              <div className="absolute h-full w-[29.4%] top-[0%] right-[70.6%] bottom-[0%] left-[0%] flex flex-row items-center justify-start gap-[8px]">
                <div className="rounded-[8px] bg-gray-400 flex flex-row p-[8px] box-border items-start justify-start">
                  <img
                    ...
                    alt=""
                    src="../assets/vuesaxboldwallet6.svg"
                  />
                </div>
                ...
                <div className="absolute top-[0px] left-[0px] w-[124px] h-[48px]">
                  ...
                  <div className="absolute top-[calc(50%_-_11px)] left-[calc(50%_-_42px)] w-[84px] flex flex-row items-center justify-center gap-[10px]">
                    <img
                      className="relative w-[20px] h-[20px] shrink-0"
                      alt=""
                      src="../assets/vuesaxlinearcard13.svg"
                    />
                ...
                >
                  ...
                  <div className="absolute top-[calc(50%_-_11px)] left-[calc(50%_-_42px)] w-[84px] flex flex-row items-center justify-center gap-[10px]">
                    <img
                      className="relative w-[20px] h-[20px] shrink-0"
                      alt=""
                      src="../assets/vuesaxlinearmoneys7.svg"
                    />
                    <div className="relative font-medium inline-block">
                      Withdraw
                    </div>
      ...
      <div className="absolute h-[70.37%] top-[12.73%] bottom-[16.9%] left-[542px] w-[436px] text-7xl text-gray-1600">
        <div className="absolute h-full top-[0%] bottom-[0%] left-[0px] w-[436px]">
          ...
          <div className="absolute top-[28px] left-[28px] flex flex-col items-start justify-start gap-[18px]">
              ...
              <div className="flex flex-col items-center justify-start gap-[28px]">
                <div className="flex flex-row items-center justify-center gap-[10px]">
                  <img
                    ...
                    alt=""
                    src="../assets/vuesaxlinearcard14.svg"
                  />
                  <div className="relative font-medium inline-block">
                    Transaction details
                  </div>
                  ...
                  <div className="flex flex-col items-start justify-start gap-[4px]">
                    ...
                    <div className="flex flex-row items-center justify-start gap-[9px] text-3xl text-gray-1600">
                      ...
                      <img
                        ...
                        alt=""
                        src="../assets/vuesaxlineardocumentcopy7.svg"
                      />
                    </div>
                  </div>
                  <div className="flex flex-col items-start justify-start gap-[4px]">
                  ...
                  <div className="flex flex-col items-start justify-start gap-[4px]">
                    ...
                    <div className="flex flex-row items-center justify-start gap-[9px] text-3xl text-gray-1600">
                      ...
                      <img
                        className="relative w-[20px] h-[20px] shrink-0"
                        alt=""
                        src="../assets/vuesaxlineardocumentcopy8.svg"
                      />
                    </div>
                  </div>
                  <div className="flex flex-col items-start justify-start gap-[4px]">
            ...
            >
              <img
                className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] max-w-full overflow-hidden max-h-full"
                alt=""
                src="../assets/vuesaxlinearadd1.svg"
              />
            </Link>
          </div>
