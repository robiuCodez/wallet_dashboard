...
const AddBankDetails: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[748px]">
          ...
          <div className="flex flex-col items-center justify-start gap-[40px]">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              <img
                ...
                alt=""
                src="../assets/group-44749.svg"
              />
              <div className="flex flex-col items-center justify-start gap-[8px]">
                <b className="relative inline-block">Add bank details</b>
                <div className="relative text-3xl leading-[24px] text-gray-700 inline-block w-[297px]">
                  Enter your bank details
                </div>
              </div>
            </div>
            <div className="flex flex-col items-start justify-start gap-[40px] text-left text-3xl">
              <div className="flex flex-col items-start justify-start gap-[20px]">
                <FormControl
                  ...
                  required
                >
                  <InputLabel color="primary">Bank</InputLabel>
                  <Select
                    color="primary"
                    defaultValue="bank"
                    size="medium"
                ...
                <div className="flex flex-col items-end justify-start gap-[6px]">
                  <TextField
                    ...
                    required
                  />
                  <div className="w-[336px] flex flex-row items-start justify-end">
                    <b className="relative leading-[130%] inline-block">
                      Investor Seed
                    </b>
                  </div>
                </div>
                <div className="flex flex-col items-start justify-start gap-[10px] text-base text-brown-200">
                  <TextField
                    className="[border:none] bg-[transparent] relative"
                    sx={{ width: 348 }}
                    color="primary"
                    ...
                    required
                  />
                  <div className="w-[336px] flex flex-row items-center justify-start gap-[8px]">
                    <img
                      className="relative w-[16px] h-[16px] shrink-0"
                      alt=""
                      src="../assets/status26.svg"
                    />
                    <div className="flex-1 relative leading-[130%] font-medium inline-block">
                      BVN doesn’t match account number
                    </div>
                  </div>
                </div>
              </div>
