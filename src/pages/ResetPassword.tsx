...
const ResetPassword: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[594px]">
        <div className="absolute top-[88px] left-[102px] flex flex-col items-center justify-start gap-[40px]">
          <div className="flex flex-col items-center justify-start gap-[40px]">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              ...
              />
              <b className="relative inline-block">Enter current password</b>
            </div>
            <div className="flex flex-col items-start justify-start gap-[40px] text-left text-base text-brown-200">
              <div className="rounded-[16px] bg-white flex flex-col items-start justify-start gap-[10px]">
                <TextField
