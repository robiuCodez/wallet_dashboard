...
const RemoveBank: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-left text-5xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[0px] left-[0px] w-[1512px] h-[65px] text-white">
        ...
        >
          <img
            ...
            alt=""
            src="../assets/vuesaxboldnotification77.svg"
          />
      ...
      <div className="absolute top-[125px] left-[449px] rounded-[20px] [border:1px_solid_#e8e8e8] box-border w-[614px] h-[809px] overflow-hidden text-8xl">
              ...
              <div className="rounded-[18px] bg-gray-400 w-[534px] h-[102px] shrink-0 flex flex-col p-[21px_21px_21px_20px] box-border items-start justify-start">
                <div className="relative w-[490px] h-[61.11px] shrink-0">
                  <img
                    ...
                    alt=""
                    src="../assets/vuesaxlineartrash6.svg"
                  />
        ...
        <div className="absolute bottom-[70px] left-[calc(50%_-_190px)] w-[380px] h-[54px] text-center text-5xl text-white">
          ...
          <div className="absolute top-[calc(50%_-_13px)] left-[calc(50%_-_42px)] w-[84px] flex flex-row items-center justify-center gap-[8px]">
            <img
              className="relative w-[24px] h-[24px] shrink-0"
              alt=""
              src="../assets/vuesaxlinearadd2.svg"
            />
            <div className="relative font-medium inline-block">
              Add new bank
            </div>
      ...
      <div className="absolute top-[125px] left-[542px] rounded-[19px] bg-white w-[428px] h-[396px] overflow-hidden text-center text-9xl">
          ...
          <div className="flex flex-col items-center justify-start gap-[18px]">
            ...
            <div className="flex flex-col items-center justify-start gap-[8px]">
              <b className="relative inline-block">
                ...
                <p className="m-[0]">remove this account?</p>
              </b>
        ...
        <img
          className="absolute top-[28px] right-[28px] w-[24px] h-[24px]"
          alt=""
          src="../assets/vuesaxlinearclose5.svg"
        />
      </div>
    </div>
  );
