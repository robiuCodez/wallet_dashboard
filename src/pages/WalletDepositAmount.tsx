...
const WalletDepositAmount: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-11xl text-gray-1600 font-dm-sans">
      <div className="absolute top-[125px] left-[449px] rounded-[20px] [border:1px_solid_#e8e8e8] box-border w-[614px] h-[467px] overflow-hidden">
        <div className="absolute top-[40px] left-[117px] flex flex-col items-start justify-start gap-[28px]">
          <div className="flex flex-col items-center justify-start gap-[40px] z-[0]">
            ...
            <div className="overflow-y-auto flex flex-col items-center justify-start gap-[40px] text-left text-base text-gray-700">
              <TextField
              ...
              <div className="flex flex-col items-start justify-start gap-[28px]">
                <Link
                  className="cursor-pointer [text-decoration:none] relative w-[380px] h-[80px] shrink-0 text-[inherit]"
                  to="/top-up-method"
                >
                  <Link
                    className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[0px] w-[380px] h-[80px] text-[inherit]"
                    to="/top-up-method"
                  >
                ...
                <div className="relative w-[380px] h-[54px] shrink-0 opacity-[0.6] text-center text-5xl text-white">
                  ...
                  <div className="absolute h-[38.89%] w-[16.84%] top-[31.48%] right-[41.58%] bottom-[29.63%] left-[41.58%] font-medium inline-block">
                    Proceed
                  </div>
                </div>
              </div>
...
export default WalletDepositAmount;
