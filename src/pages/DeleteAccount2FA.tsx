...
const DeleteAccount2FA: FunctionComponent = () => {
  return (
          ...
          <div className="flex flex-col items-center justify-start gap-[40px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[20px] text-left text-5xl">
              <Link
                ...
                to="/delete-account-otp"
              >
                <div className="absolute top-[0px] left-[0px] w-[380px] h-[113px]">
...
export default DeleteAccount2FA;
