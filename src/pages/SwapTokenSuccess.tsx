...
const SwapTokenSuccess: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-white font-dm-sans">
      ...
      <div className="absolute top-[125px] left-[449px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[614px] h-[567px] overflow-hidden text-3xl text-gray-1400">
                ...
                <div className="flex flex-col items-center justify-start gap-[28px]">
                  ...
                  <div className="flex flex-col items-start justify-start gap-[18px] text-3xl text-gray-1400">
                    <div className="relative w-[332px] h-[24px] shrink-0">
                      ...
                      <div className="absolute top-[0px] left-[214px] flex flex-row items-center justify-center gap-[4px] text-gray-1600">
                        ...
                        <img
                          ...
                          alt=""
                          src="../assets/vuesaxlineararrowdown1.svg"
                        />
                      </div>
                    </div>
                    <div className="relative w-[332px] h-[24px] shrink-0">
                      ...
                      <div className="absolute top-[0px] left-[212px] flex flex-row items-center justify-center gap-[4px] text-gray-1600">
                        <div className="relative leading-[170%] font-medium inline-block mix-blend-normal">
                          Wallet balance
                        </div>
                        <img
...
export default SwapTokenSuccess;
