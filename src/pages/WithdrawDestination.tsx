...
const WithdrawDestination: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-gray-1600 font-dm-sans">
      ...
      <div className="absolute top-[125px] left-[542px] rounded-[22px] bg-white w-[436px] h-[566px] overflow-hidden">
        <div className="absolute top-[40px] left-[28px] flex flex-col items-center justify-start gap-[28px]">
          <div className="flex flex-col items-center justify-start gap-[18px] text-9xl">
            <img
              className="relative w-[80px] h-[80px] shrink-0"
              alt=""
              src="../assets/group-44716.svg"
            />
            <div className="flex flex-col items-center justify-start gap-[8px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[20px] text-left">
            <div className="relative w-[380px] h-[89px] shrink-0">
              <div className="absolute top-[0px] left-[0px] rounded-[16px] bg-gray-400 w-[380px] flex flex-col p-[18px] box-border items-start justify-start">
                <div className="relative w-[344px] h-[53px] shrink-0">
                  <FormControlLabel
                    className="absolute top-[17px] left-[324px]"
                    label=""
          ...
          <div className="flex flex-col items-center justify-start gap-[20px]">
            <Button
              ...
              variant="contained"
              color="primary"
              href="/withdraw-complete"
            >
              Select
            </Button>
            <div className="relative w-[380px] h-[54px] shrink-0">
              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[10px] opacity-[0]" />
              <div className="absolute top-[15px] left-[148px] w-[84px] flex flex-row items-center justify-center gap-[8px]">
                <img
                  className="relative w-[24px] h-[24px] shrink-0"
                  alt=""
                  src="../assets/vuesaxlinearadd.svg"
                />
                <div className="relative font-medium [background:linear-gradient(89.2deg,_#2f79f9,_#3daefa)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block">
                  Add new account
                </div>
              </div>
            </div>
        ...
        <img
          className="absolute h-[4.12%] top-[4.81%] right-[28px] bottom-[91.07%] max-h-full w-[24px]"
          alt=""
          src="../assets/vuesaxlinearclose2.svg"
        />
      </div>
    </div>
  );
