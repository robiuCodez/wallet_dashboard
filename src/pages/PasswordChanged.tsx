...
const PasswordChanged: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[982px] overflow-hidden text-center text-5xl text-white font-dm-sans">
      <div className="absolute top-[0px] left-[0px] w-[1512px] h-[65px] text-left">
        ...
        <div className="absolute h-[64.62%] w-[24.67%] top-[33.85%] right-[37.63%] bottom-[1.54%] left-[37.7%] text-gray-1400">
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] flex flex-row items-start justify-start gap-[50px] opacity-[0]">
        ...
        <div className="absolute h-[61.54%] w-[2.65%] top-[18.46%] right-[10.58%] bottom-[20%] left-[86.77%] opacity-[0]">
          <img
        ...
        >
          <img
            className="absolute h-full w-[90.32%] top-[64.29%] right-[-4054.84%] bottom-[-64.29%] left-[4064.52%] max-w-full overflow-hidden max-h-full opacity-[0]"
            alt=""
          />
          <div className="absolute h-[46.43%] w-[58.06%] top-[0%] right-[0%] bottom-[53.57%] left-[41.94%] rounded-[10px] bg-brown-100 flex flex-col p-[1.5px_4px] box-border items-center justify-center opacity-[0]">
      ...
      <div className="absolute top-[125px] left-[480px] rounded-[20px] bg-white [border:1px_solid_#e8e8e8] box-border w-[552px] h-[717px]">
        <div className="absolute top-[88px] left-[86px] flex flex-col items-center justify-start gap-[40px]">
          <div className="flex flex-col items-center justify-start gap-[40px] text-11xl text-gray-1600">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              <img
                className="relative w-[90px] h-[90px] shrink-0"
                alt=""
                src="../assets/group-44710.svg"
              />
          ...
          <div className="relative w-[380px] h-[54px] shrink-0">
            <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[10px] [background:linear-gradient(89.2deg,_#2f79f9,_#3daefa)]" />
            <div className="absolute top-[calc(50%_-_10px)] left-[calc(50%_-_22px)] font-medium inline-block">
              Finish
            </div>
          </div>
        </div>
      ...
      <div className="absolute top-[125px] left-[542px] rounded-[19px] bg-white w-[428px] h-[330px] overflow-hidden text-9xl text-gray-1600">
        <div className="absolute top-[50px] left-[61px] w-[306px] flex flex-col items-center justify-start">
          <div className="flex flex-col items-center justify-start gap-[18px]">
            ...
            />
            <div className="flex flex-col items-center justify-start gap-[8px]">
              <b className="relative inline-block w-[224px]">
        ...
        <div className="absolute w-[calc(100%_-_48px)] right-[24px] bottom-[24px] left-[24px] flex flex-col items-start justify-start gap-[18px] text-5xl text-white">
          <div className="relative w-[380px] h-[54px] shrink-0">
            <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[10px] bg-green-100" />
            <div className="absolute top-[calc(50%_-_10px)] left-[calc(50%_-_20px)] font-medium inline-block">
              Done
            </div>
          </div>
          <div className="relative w-[380px] h-[54px] shrink-0 hidden">
